...
function contarPalabras(mensaje) {
    ...
    // Crear un objeto para llevar un registro del número de veces que aparece cada palabra
    const conteo = {};
    ...
    // Crear una cadena de texto con las palabras y su conteo en el formato requerido
    let resultado = '';
